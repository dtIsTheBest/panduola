...
| Spec 章节 | 任务 | 说明 |
|-----------|------|------|
| 3.1 功能性需求 | Task 1、2、3、5、6、12、13、14 | 覆盖全局、骨架、首页、AI、链接库、管理弹窗、内容 Tab、系统加固、品牌、导航与主题切换 |
| 3.2 非功能性需求 | Task 1、2、3、4、5、6、7、14 | 覆盖兼容、响应式、离线、性能、动效、安全、可访问性和主题偏好隔离 |
...
| 7.1 单元测试 | Task 6、14 | 使用 Node 内置测试运行器覆盖安全 URL、迁移、导入、Tauri 识别、并发写入和主题管理 |
| 7.2-7.3 测试计划 | Task 4、5、7、12、13、14 | 构建、浏览器冒烟、内容边界、Tab 键盘、品牌、导航及三主题响应式检查 |
